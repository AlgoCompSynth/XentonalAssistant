...
#' # can we recover them?
#' (hexany <- prodset_scale_generate(list(
#'   c(1, 3),
#'   c(1, 5),
#'   c(1, 7),
#'   c(3, 5),
...
#' \insertCite{sethares2013tuning}{XentonalAssistant}
#' @references
#' \insertAllCited{}
...
#' @examples
#'
#' print(vanilla <- et_scale_generate()) # default is 12EDO, of course
#'
#' # 19-EDO
#' print(edo19 <- et_scale_generate(2.0, 19))
#'
#' # 31-EDO
#' print(edo31 <- et_scale_generate(2.0, 31))
#'
#' # equal-tempered Bohlen-Pierce
#' print(bohlen_pierce_et <- et_scale_generate(3.0, 13))
#'
#' # Carlos Alpha
#' print(carlos_alpha <- et_scale_generate(1.5, 9))

et_scale_generate <- function(
    period = 2.0,
    divisions = 12,
...
prodset_scale_generate <- function(
  prodset_def,
  period = 2,
...
#' @examples
#'
#' print(vanilla <- et_scale_named()) # default is 12EDO, of course
#'
#' # 19-EDO
#' print(edo19 <- et_scale_named(edo19_names))

#' # 31-EDO
#' print(edo31 <- et_scale_named(edo31_names))
#'
#' # equal-tempered Bohlen-Pierce
#' print(bohlen_pierce_et <- et_scale_named(bohlen_pierce_et_names, period = 3))

et_scale_named <- function(note_names = c(
  "C",
  "C#|Db",
  "D",
  "D#|Eb",
...
#' `cps_scale_table`, or `et_scale_named`
...
#' print(vanilla_keyboard_map <- keyboard_map(et_scale_named()), nrows = 128)
#'
...
#' bohlen_pierce_et_scale <- et_scale_named(bohlen_pierce_et_names, period = 3)
